...
import { GetCustomerListResponseDto, GetCustomerResponseDto } from 'src/apis/dto/response/customer';
...
export default function CSUpdate() {
  ...
  const getCustomerResponse = (responseBody: GetCustomerListResponseDto | ResponseDto | null) => {
    const message =
  ...
  const onAddressButtonClickHHandler = () => {
      ...
      <div className='main'>
        ...
        <div className='input-container'>
          ...
          <div className='input-box'>
            ...
            <div className='button-box'>
              <div className='button disable' onClick={onAddressButtonClickHHandler}>검색</div>
            </div>
          </div>
        </div>
      </div>
